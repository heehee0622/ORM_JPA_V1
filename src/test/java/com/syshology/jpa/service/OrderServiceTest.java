...
import com.syshology.jpa.type.OrderStatus;
...
public class OrderServiceTest {
    ...
    public void 상품준문() throws Exception {
        ...
        //Then
        Order getOrder = orderRepository.findOne(orderId).orElseThrow(() -> new IllegalStateException("주문정보가 존재 하지 않급니다."));
    ...
    public void 주문취소() throws Exception {
        ...
        //When
        Order getOrder = orderRepository.findOne(orderId).orElseThrow(() -> new IllegalStateException("주문 정보가 존재 하지 않습니다."));
        //Then
